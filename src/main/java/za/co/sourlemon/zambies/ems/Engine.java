...
{
    Collection<ISystem> systems = new ArrayList<>();
    Collection<Entity> entities = new ArrayList<>();
    Collection<Entity> toAdd = new ArrayList<>();
    Collection<Entity> toRemove = new ArrayList<>();
    Map<Class, Collection<Object>> nodeLists = new HashMap<>();
    Map<Class, Family> families = new HashMap<>();
